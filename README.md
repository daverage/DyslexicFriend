...
- Adjust overlay opacity up to 60% while keeping forms, links, and scrolling fully interactive.
...
4. Use the popup to toggle the OpenDyslexic font and fine-tune the overlay color and strength to your needs.
